...
export default async function LoginPage() {
  ...
  return (
    <main className="grid min-h-[100dvh] lg:grid-cols-[0.78fr_1.22fr]">
      <section className="flex min-h-[100dvh] flex-col px-5 py-5 sm:px-10 sm:py-8 lg:px-12">
      ...
      <aside className="relative hidden max-h-[100dvh] min-h-[100dvh] overflow-hidden border-l bg-slate-200 lg:block dark:bg-slate-950">
